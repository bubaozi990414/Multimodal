...
#图片及音频路径
    ...
    parser.add_argument("--source_image", default='./result/background_image/background_image1.png', help="path to source image")
...
#解析输入和输出的 checkpoint_dir 和 result_dir
    ...
    parser.add_argument("--result_dir", default='./result/video', help="path to output")
