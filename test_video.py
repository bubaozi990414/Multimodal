...
parser.add_argument('--video', type=str, default='./input_video/video3.mp4')#,required=True)
parser.add_argument('--output-video', type=str, default='./result/input_video/video3_new.mp4')#required=True)
...
if not ret:
    print('Failed to read the input_image video: {0}'.format(args.video))
    exit()
